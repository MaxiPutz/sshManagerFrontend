    ...
    return (react_1.default.createElement("div", { className: "App" },
        react_1.default.createElement("ul", { className: "overflow-hidden bg-blue-500 m-0 p-0 list-none" },
            ...
            react_1.default.createElement("li", { className: "float-left p-5" + ((selectRoute === isLockSlice_1.routeUris.sshCreate) ? " bg-black" : "") },
                " ",
                react_1.default.createElement("button", { onClick: function () { return dispatch((0, isLockSlice_1.setRoute)(isLockSlice_1.routeUris.sshCreate)); }, className: "text-white" }, " SSH Create                ")),
            react_1.default.createElement("li", { className: "float-left p-5" + ((selectRoute === isLockSlice_1.routeUris.action) ? " bg-black" : "") },
                " ",
                react_1.default.createElement("button", { onClick: function () { return dispatch((0, isLockSlice_1.setRoute)(isLockSlice_1.routeUris.action)); }, className: "text-white" }, " Dashboard                ")),
            react_1.default.createElement("li", { className: "float-left p-5" + ((selectRoute === isLockSlice_1.routeUris.shell) ? " bg-black" : "") },
                " ",
                react_1.default.createElement("button", { onClick: function () { return dispatch((0, isLockSlice_1.setRoute)(isLockSlice_1.routeUris.shell)); }, className: "text-white" }, " Shell                ")),
            selectUser.Name !== "" ?
