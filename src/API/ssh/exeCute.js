...
var sshExe = function (ssHInfo, sshExe, user) { return __awaiter(void 0, void 0, void 0, function () {
    var url, merge;
    return __generator(this, function (_a) {
        url = serverAdress_1.getUrl + "/ssh/exe";
        console.log(JSON.stringify(ssHInfo));
        console.log(url);
        merge = __assign(__assign({}, ssHInfo), sshExe);
        console.log(merge);
        try {
