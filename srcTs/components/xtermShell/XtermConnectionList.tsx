...
import { ShellSession, selectXtermShell, setXtermShellSession } from "../../store/shell/xtermShell";
import {  setShellSession, ShellSession as ShellSession2, selectShell } from "../../store/shell/shell";
...
export function XtermConnectionList() {
